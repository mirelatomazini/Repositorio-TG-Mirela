...
void loop() {
  ...
  if(1==1){
    if(flag_inicial){
      ...
      fpeak = search_fpeak_initial_faster (data16, sample_freq, FREQ0);
      flag_inicial = 0;
    }
    fpeak = search_fpeak_initial(data16, sample_freq, 10000, 50, fpeak-100, fpeak+110,10,BUFFER_SIZE); 
    fpeak = test2 (data16, sample_freq, 10000, 50,fpeak-100, fpeak+110,10);
